 ...
 * Everything here must remain valid after package-specific sections are transformed.
 * Note: Before image filter defaults to "none" so the Before image renders in its original state.
 * The PRO build expands the whitelist below and reads the user-selected value.
 */
